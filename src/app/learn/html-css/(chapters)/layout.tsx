 ...
 *
 * The track index at /learn/html-css sits outside the group and keeps its own layout.
 */
export default function HtmlCssChaptersLayout({ children }: { children: React.ReactNode }) {
  return children;
}
