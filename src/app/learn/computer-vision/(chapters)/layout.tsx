 ...
 * segment makes it persist. Same reasoning as the ML track.
 *
 * The track index at /learn/computer-vision sits outside the group and keeps
 * its own layout.
 */
export default function ComputerVisionChaptersLayout({ children }: { children: React.ReactNode }) {
  return children;
}
