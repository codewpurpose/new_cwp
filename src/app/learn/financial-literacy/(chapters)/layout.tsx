 ...
 * tracks.
 *
 * The track index at /learn/financial-literacy sits outside the group and keeps its own layout.
 */
export default function FinancialLiteracyChaptersLayout({ children }: { children: React.ReactNode }) {
  return children;
}
