 ...
 *
 * The track index at /learn/roblox sits outside the group and keeps its own layout.
 */
export default function RobloxChaptersLayout({ children }: { children: React.ReactNode }) {
  return children;
}
