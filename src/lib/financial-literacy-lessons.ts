...
export const FINANCIAL_LITERACY_CHAPTERS: readonly LearnChapter[] = [
  {
    ...
    headings: [
      ...
      { id: "present-bias-has-a-specific-shape", text: "Present bias has a specific shape", level: 2 },
  ...
  },
  {
    ...
    headings: [
      ...
      { id: "what-actually-comes-out-of-a-payslip", text: "What actually comes out of a payslip", level: 2 },
      { id: "expenses-split-into-fixed-and-variable", text: "Expenses split into fixed and variable", level: 2 },
      { id: "the-irregular-expenses-that-actually-break-a-budget", text: "The irregular expenses that actually break a budget", level: 2 },
  ...
  },
  {
    ...
    headings: [
      ...
      { id: "hedonic-adaptation-quietly-turns-wants-into-needs", text: "Hedonic adaptation quietly turns wants into needs", level: 2 },
      { id: "the-line-moves-with-circumstances-not-morals", text: "The line moves with circumstances, not morals", level: 2 },
      { id: "a-three-question-test-for-the-blurry-middle", text: "A three-question test for the blurry middle", level: 2 },
    ],
    status: "published",
  },
  {
    ...
    headings: [
      ...
      { id: "a-budget-forecasts-a-record-just-remembers", text: "A budget forecasts; a record just remembers", level: 2 },
      ...
      { id: "the-four-steps-to-a-first-real-budget", text: "The four steps to a first real budget", level: 2 },
    ],
    status: "published",
  },
  {
    ...
    headings: [
      ...
      { id: "what-counts-as-an-emergency-and-what-doesnt", text: "What counts as an emergency, and what doesn't", level: 2 },
      ...
      { id: "funding-it-before-or-after-high-interest-debt", text: "Funding it before or after high-interest debt", level: 2 },
    ],
    status: "published",
  },
  {
    ...
    headings: [
      ...
      { id: "an-account-paying-under-inflation-is-losing-you-money", text: "An account paying under inflation is losing you money", level: 2 },
  ...
  },
  {
    ...
    headings: [
      ...
      { id: "the-rule-of-72-turns-a-rate-into-a-timeline", text: "The rule of 72 turns a rate into a timeline", level: 2 },
      { id: "the-same-monthly-amount-ten-years-earlier", text: "The same monthly amount, ten years earlier", level: 2 },
      { id: "the-first-five-years-feel-like-nothing", text: "The first five years feel like nothing", level: 2 },
      { id: "why-the-rate-matters-less-than-the-runway", text: "Why the rate matters less than the runway", level: 2 },
      { id: "the-same-maths-runs-in-reverse-on-debt", text: "The same maths runs in reverse on debt", level: 2 },
    ],
    status: "published",
  },
  {
    ...
    headings: [
      ...
      { id: "automation-fails-in-two-specific-avoidable-ways", text: "Automation fails in two specific, avoidable ways", level: 2 },
  ...
  },
  {
    ...
    headings: [
      ...
      { id: "what-utilisation-actually-measures", text: "What utilisation actually measures", level: 2 },
      { id: "the-balance-your-score-sees-isnt-the-one-you-just-paid", text: "The balance your score sees isn't the one you just paid", level: 2 },
      ...
      { id: "two-myths-worth-retiring", text: "Two myths worth retiring", level: 2 },
    ],
    status: "published",
  },
  {
    ...
    headings: [
      ...
      { id: "how-the-minimum-payment-is-actually-calculated", text: "How the minimum payment is actually calculated", level: 2 },
      { id: "a-cash-advance-is-a-worse-loan-inside-the-same-card", text: "A cash advance is a worse loan inside the same card", level: 2 },
      { id: "deferred-interest-promotions-charge-for-the-whole-purchase", text: "Deferred interest promotions charge for the whole purchase", level: 2 },
    ],
    status: "published",
  },
  {
    ...
    headings: [
      ...
      { id: "the-real-payoff-timeline-runs-years-past-a-single-chart", text: "The real payoff timeline runs years past a single chart", level: 2 },
  ...
  },
  {
    ...
    headings: [
      ...
      { id: "the-interest-share-falls-every-month-not-evenly", text: "The interest share falls every month, not evenly", level: 2 },
      { id: "why-an-extra-payment-early-saves-more-than-one-late", text: "Why an extra payment early saves more than one late", level: 2 },
      { id: "what-one-extra-payment-a-year-actually-does", text: "What one extra payment a year actually does", level: 2 },
    ],
    status: "published",
  },
  {
    ...
    headings: [
      ...
      { id: "the-rate-the-term-and-whether-it-survives-a-lost-paycheck", text: "The rate, the term, and whether it survives a lost paycheck", level: 2 },
  ...
  },
  {
    ...
    headings: [
      ...
      { id: "refinancing-and-consolidation-and-where-each-goes-wrong", text: "Refinancing and consolidation, and where each goes wrong", level: 2 },
    ],
    status: "published",
  },
  {
    ...
    headings: [
      ...
      { id: "insure-the-catastrophic-and-unaffordable-not-the-small-and-frequent", text: "Insure the catastrophic and unaffordable, not the small and frequent", level: 2 },
  ...
  },
  {
    ...
    headings: [
      ...
      { id: "rent-to-own-and-the-advance-fee-trick", text: "Rent-to-own and the advance-fee trick", level: 2 },
      { id: "the-same-tricks-in-a-browser-tab-now", text: "The same tricks, in a browser tab now", level: 2 },
  ...
  },
  {
    ...
    headings: [
      ...
      { id: "the-average-return-is-a-summary-not-a-promise", text: "The average return is a summary, not a promise", level: 2 },
  ...
  },
  {
    ...
    headings: [
      ...
      { id: "the-expense-ratio-is-the-fee-you-never-see-charged", text: "The expense ratio is the fee you never see charged", level: 2 },
    ],
    status: "published",
  },
  {
    ...
    tags: ["Investing", "Interactive"],
    headings: [
      { id: "risk-is-the-spread-of-outcomes-not-a-feeling-of-danger", text: "Risk is the spread of outcomes, not a feeling of danger", level: 2 },
      ...
      { id: "correlation-is-whether-things-move-together", text: "Correlation is whether things move together", level: 2 },
      ...
      { id: "the-risk-you-cant-diversify-away", text: "The risk you can't diversify away", level: 2 },
  ...
  },
  {
    ...
    headings: [
      ...
      { id: "the-arithmetic-that-most-active-funds-must-lose", text: "The arithmetic that most active funds must lose", level: 2 },
  ...
  },
  {
    ...
    headings: [
      ...
      { id: "pre-tax-and-post-tax-are-a-bet-on-which-tax-rate-is-lower", text: "Pre-tax and post-tax are a bet on which tax rate is lower", level: 2 },
      ...
      { id: "vesting-decides-when-the-match-is-actually-yours", text: "Vesting decides when the match is actually yours", level: 2 },
      { id: "early-withdrawal-turns-the-tax-break-into-a-trap", text: "Early withdrawal turns the tax break into a trap", level: 2 },
  ...
  },
  {
    ...
    headings: [
      ...
      { id: "deductions-and-credits-are-not-the-same-thing", text: "Deductions and credits are not the same thing", level: 2 },
      { id: "why-a-raise-can-never-actually-shrink-your-paycheck", text: "Why a raise can never actually shrink your paycheck", level: 2 },
      { id: "withholding-is-a-guess-and-a-refund-means-it-guessed-wrong", text: "Withholding is a guess, and a refund means it guessed wrong", level: 2 },
    ],
    status: "published",
  },
  {
    ...
    headings: [
      ...
      { id: "total-cost-of-ownership-is-more-than-the-sticker-price", text: "Total cost of ownership is more than the sticker price", level: 2 },
      ...
      { id: "the-same-math-applied-to-a-college-degree", text: "The same math, applied to a college degree", level: 2 },
  ...
  },
  {
    ...
    headings: [
      ...
      { id: "what-to-actually-do-this-week", text: "What to actually do this week", level: 2 },
      { id: "the-one-page-plan-you-can-actually-maintain", text: "The one-page plan you can actually maintain", level: 2 },
      { id: "what-this-track-didnt-cover", text: "What this track didn't cover", level: 2 },
    ],
    status: "published",
  },
];
