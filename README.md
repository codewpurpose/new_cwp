...
Eight self-paced tracks live under `/learn`. All run on the same documentation shell — sidebar, table of contents, prev/next pager — so they read as one product.
...
src/
  ...
  components/
    ...
    html-css/       HTML and CSS interactives and prose
